 ...
 * @since BuddyBoss 1.1.5
 */
class BB_PROJECTPOST_BuddyBoss_Admin_Integration_Tab extends BP_Admin_Integration_tab {
	...
	public function register_fields() {
		...
		$sections = BB_PROJECTPOST_get_settings_sections();

		foreach ( (array) $sections as $section_id => $section ) {

			// Only add section and fields if section has fields
			$fields = BB_PROJECTPOST_get_settings_fields_for_section( $section_id );
